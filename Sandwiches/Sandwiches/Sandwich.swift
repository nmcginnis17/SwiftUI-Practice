...
let testData = [
    ...
    Sandwich(name: "Pastrami on rye", ingredientCount: 4, isSpicy: false),
    Sandwich(name: "French dip", ingredientCount: 3, isSpicy: false),
    Sandwich(name: "Banh mi", ingredientCount: 5, isSpicy: false),
    ...
    Sandwich(name: "Hot dog", ingredientCount: 2, isSpicy: false),
